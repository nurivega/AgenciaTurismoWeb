                                                ...
                                                <div class="col-xs-12 col-md-10 col-md-offset-1">
                                                    <form action="SvModificarServicio" method="get">
                                                        ...
                                                        <div class="form-group label-floating">
                                                            ...
                                                            <input class="form-control" type="text" name="descripcion" value="<%=serv.getDescripcion()%>">
                                                        </div>
                                                        <div class="form-group label-floating">
                                                            <label class="control-label">destino</label>
                                                            <input class="form-control" type="text" name="destino" value="<%=serv.getDestino()%>">
                                                        </div>
                                                        <div class="form-group label-floating">
                                                            <label class="control-label">Costo</label>
                                                            <input class="form-control" type="text" name="costo" value="<%=serv.getCosto()%>">
                                                        </div>s
                                                        <div class="form-group label-floating">
                                                            <label class="control-label">Fecha nacimiento</label>
                                                            <% Date fecha = serv.getFechaInicio();
                                                                SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd");
                                                                String fechaInicio = sdf.format(fecha);
                                                            %>
                                                            <input class="form-control" type="date" name="fechaInicio" value="<%=fechaInicio%>">
                                                        </div>
                                                        <div class="form-group label-floating">
                                                            <input class="form-control" type="hidden" name="id" value="<%=serv.getCodigo()%>">
                                                        </div>
                                                        <p class="text-center">
