	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Modificar Cliente <small></small></h1>
			
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
					<ul class="nav nav-tabs" style="margin-bottom: 15px;">
					  	<li class="active"><a href="#new" data-toggle="tab">Datos del cliente</a></li>
					</ul>
									...
									<div class="col-xs-12 col-md-10 col-md-offset-1">
											...
											<div class="form-group label-floating">
											  <label class="control-label">Telefono</label>
                                                                                          <input class="form-control" type="text" name="telefono" value="<%=cli.getCelular()%>">
											</div>
                                                                                        <div class="form-group label-floating">
											...
											<div class="form-group label-floating">
											  <label class="control-label">Email</label>
                                                                                          <input class="form-control" type="email" name="email" value="<%=cli.getEmail()%>">
											</div>
                                                                                      <div class="form-group label-floating">
                                                                                            <input class="form-control" type="hidden" name="id" value="<%=cli.getCodigo()%>">
											</div>
										    <p class="text-center">
