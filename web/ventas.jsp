<%-- 
    Document   : ventas
    Created on : 09-dic-2021, 17:11:17
    Author     : nurivega
--%>
...
<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Ventas</h1>
			...
			<div class="row">
				<div class="col-xs-12">
					<ul class="nav nav-tabs" style="margin-bottom: 15px;">
					  	...
					  	<li><a href="#list" data-toggle="tab">Lista Ventas</a></li>
					</ul>
								...
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
											  ...
											  <label class="control-label">Fecha venta</label>
                                                                                          <input class="form-control" type="date" name="fechaVenta">
											</div>     
                                                                                         <div class="form-group label-floating">
										    ...
										    <p class="text-center">
										    	<button href="#!" class="btn btn-info btn-raised btn-sm"><i class="zmdi zmdi-floppy"></i> Siguiente </button>
										    </p>
									    </form>
									</div>
								</div>
								...
								<table class="table table-hover text-center">
									...
									<tbody>
                                                                            <% Controladora controladora = new Controladora(); 
                                                                              List<Venta> listaVentas = controladora.listarVentas();
                                                                              for (Venta ven : listaVentas){
                                                                            %>
										<tr>
                                                                                     <% Date fecha = ven.getFechaVenta();
                                                                                      SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd");
                                                                                      String fechaVenta = sdf.format(fecha);
                                                                                      %>
                                                                                      <td><%=fechaVenta%></td>
                                                                                    <% String medioPago = ven.getMedioPago();%>
                                                                                      <td><%=medioPago%></td>
                                                                                     
                                                                                     <%int id = ven.getCodigo();%>
                                                                                           <td>
                                                                                            <form name="frmBorrarEmpleado" action="SvEliminarVenta" method="post">
